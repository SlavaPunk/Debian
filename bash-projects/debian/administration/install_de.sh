...
#INFORMATION_END
  ...
  echo -e "\t1. Установка XFCE"
  echo -e "\t2. Установка LXDE"
  echo -e "\t3. Установка KDE Plasma"
  echo -e "\t4. Установка GNOME"
  echo -e "\t5. Установка IceWM"
  echo -e "\t6. Установка JWM\n"
  echo -e "\tУстановка браузера:\n"
  echo -e "\t7. Установка Firefox"
  echo -e "\t8. Установка Chromium"
  echo -e "\t9. Выход\n"
  ...
  read -n 1 option
   ...
   clear
   apt update
   apt install xorg xfce4 xfce4-terminal xfce4-xkb-plugin
   ...
   clear
   apt update
   apt install xorg lxde-core lxappearance lxappearance-obconf lxhotkey-core lxterminal
   if [ -e /bin/lxsession ]
   then
   ...
   clear
   apt update
   apt install xorg plasma-desktop plasma-nm konsole dolphin lightdm 
   ...
   clear
   apt update
   apt install xorg gnome-core gdm3
   ...
   clear
   apt update
   apt install xorg icewm pcmanfm lxterminal volumeicon-alsa fbxkb lightdm
   ...
   clear
   apt update
   apt install xorg jwm pcmanfm lxterminal volumeicon-alsa fbxkb lightdm
